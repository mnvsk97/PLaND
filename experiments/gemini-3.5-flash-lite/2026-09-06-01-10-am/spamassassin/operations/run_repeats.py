#!/usr/bin/env python3
"""Run or safely resume amendment-02 SpamAssassin selection/final repeats."""
...
RUN_DIR = ROOT / "experiments/gemini-3.5-flash-lite/2026-09-06-01-10-am/spamassassin"
RESULTS = RUN_DIR / "results"
DATASET = ROOT / "tmp/gemini-3.5-flash-lite/2026-09-06-01-10-am/datasets/spamassassin"
...
def run(stage: str, split: str, prefix: str, seed: int, arm: str) -> None:
    ...
    common = [str(PYTHON), str(RUNNER), "--dataset", str(DATASET), "--split", split,
              ...
              "--experiment-id", "gemini-3.5-flash-lite-2026-09-05-11-41-pm-amendment-02-spamassassin",
