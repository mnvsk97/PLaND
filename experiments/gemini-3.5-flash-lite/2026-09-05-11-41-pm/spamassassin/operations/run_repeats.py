#!/usr/bin/env python3
"""Run or safely resume a frozen SpamAssassin repeat stage."""
...
DATASET = ROOT / "tmp/gemini-3.5-flash-lite/2026-09-05-11-41-pm/datasets/spamassassin"
...
def run(stage: str, split: str, prefix: str, seed: int, arm: str) -> None:
    ...
    common = [str(PYTHON), str(RUNNER), "--dataset", str(DATASET), "--split", split,
              ...
              "--experiment-id", "gemini-3.5-flash-lite-2026-09-05-11-41-pm-spamassassin",
