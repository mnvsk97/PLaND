# spamassassin-email-classification three-run variance evidence
...
- NL accuracy mean (sample SD; range): 0.9020 (0.0000; 0.9020-0.9020)
- quality-first accuracy mean (sample SD; range): 0.8900 (0.0000; 0.8900-0.8900)
