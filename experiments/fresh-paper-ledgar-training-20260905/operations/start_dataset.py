...
ds=sys.argv[1]
assert ds == 'ledgar', 'Only LEDGAR is authorized'
plan_path=ROOT/f'experiments/protocol/fresh-paper-ledgar-training.json'
...
sources={'ledgar':Path('/Users/saikrishna/dev/deterministic-skills/tmp/enterprise-datasets/ledgar/sources'), 'cfpb':Path('/Users/saikrishna/dev/deterministic-skills/tmp/confirmatory-datasets/cfpb/sources'),
...
controlled(ds,'prepare','independent-freshness-check',[PYTHON,OPS/'independent_freshness_check.py','--output',directory/'independent-freshness.json'],
           [OPS/'independent_freshness_check.py',dataset,ROOT/'experiments/fresh-paper-20260905/ledgar-freshness-incident.json'],[directory/'independent-freshness.json'])
