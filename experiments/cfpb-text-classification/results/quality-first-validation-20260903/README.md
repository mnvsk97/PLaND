# cfpb-text-classification three-run variance evidence
...
- NL accuracy mean (sample SD; range): 0.7480 (0.0000; 0.7480-0.7480)
- quality-first accuracy mean (sample SD; range): 0.7380 (0.0000; 0.7380-0.7380)
