...
def main():
    ...
    if opt.artifacts:
        ...
        for phrase in ['376,088','225,573','40.02%','93.5%','92.7%','31.30%','53.14%','43.08%','Appendix A','Appendix B']:
    ...
    print(json.dumps({'status':'PASS','source_sha256':source_hash,'main_comparisons':verified,'repeated_pairs':9,'total_pairs':12,'total_runs':24,'references':18,'tables':4,'figures':3,'pdf_pages':pages},indent=2))
